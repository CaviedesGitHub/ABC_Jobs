...
export class AsignacionComponent implements OnInit {
  ...
  asignaCandidatoPerfilProyecto(perfilProyId: number, id_cand: number){
    this.abcService.asignaCandidatoPerfilProyecto(perfilProyId, id_cand).subscribe(resp => {
  ...
  actualizar(){
    this.asignaCandidatoPerfilProyecto(this.perfilProyId, this.idCand)
  }
