...
@Component({
  selector: 'app-ABC-Entrevistas',
  templateUrl: './ABC-Entrevistas.component.html',
  styleUrls: ['./ABC-Entrevistas.component.css']
})
export class ABCEntrevistasComponent implements OnInit, AfterViewInit  {
  textoEmpresa: string = '';
  ...
  displayedColumns: string[] = ['num', 'candidato', 'cuando', 'contacto', 'nom_empresa', 'nom_proyecto', 'nom_perfil', 'star'];
    ...
    merge(this.sort.sortChange, this.paginator.page)
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.abcjobsService.getEntrevistas(
            30, 
