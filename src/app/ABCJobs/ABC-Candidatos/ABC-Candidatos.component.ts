...
export class ABCCandidatosComponent implements OnInit, AfterViewInit  {
  textoCiudad: string = '';
  textoEmpresa: string = '';
  ...
  displayedColumns: string[] = ['num', 'candidato', 'documento', 'fecha_nac', 'ciudad', 'email', 'phone', 'direccion', 'star'];
