...
@Component({
  ...
  templateUrl: './ABC-Entrevistas-Ver-Resultado.component.html',
  styleUrls: ['./ABC-Entrevistas-Ver-Resultado.component.css']
})
export class ABCEntrevistasVerResultadoComponent implements OnInit {
  userId: number = 0;
  token: string = '';
