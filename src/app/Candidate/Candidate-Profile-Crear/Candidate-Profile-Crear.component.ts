...
import { PerfilProyecto } from '../../Company/Perfil-proyecto';
import { PerfilCandidato } from '../PerfilCandidato';
import { CompanyService } from '../../Company/Company.service';
import { Habil } from '../../Company/Habil';
import {SelectionModel} from '@angular/cdk/collections';
import {MatTableDataSource} from '@angular/material/table';
import { CandidateService } from '../Candidate.service';

@Component({
  selector: 'app-Candidate-Profile-Crear',
  templateUrl: './Candidate-Profile-Crear.component.html',
  styleUrls: ['./Candidate-Profile-Crear.component.css']
})
export class CandidateProfileCrearComponent implements OnInit {
  ...
  createPerfilauc(perfil: PerfilCandidato){
    console.log('perfil')
    console.log(perfil)
  }
  createPerfil(perfil: PerfilCandidato){
    //this.toastr.success("Confirmation", this.selectedValue)
    //this.selectedH=this.selectedHT+','+this.selectedHB+','+this.selectedHP
    //this.perfilForm.controls['lstHabils'].setValue(String(this.selectedH));
    //this.selectedH=this.selectedHT+','+this.selectedHB+','+this.selectedHP
    //perfil.lstHabils="5,7"
    this.candidateService.createPerfil(perfil, this.candId).subscribe(res=>{
        ...
        this.enrutador.navigate(['/detalleCandidato'])
      },
      error => {
        this.error = true
